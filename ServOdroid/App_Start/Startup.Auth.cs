    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseTwitterAuthentication(
               ...
               consumerSecret: "12345789");

            app.UseFacebookAuthentication(
               appId: "1705001929734858",
               appSecret: "ffafdf4b593b42af0fdbca7a03eba34f");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "1055371120149-lkvdq72ss7dfk30t28iadija288ausr6.apps.googleusercontent.com",
                ClientSecret = "f7K-8_XYOd6mzLYLuNByveRz"
            });
        }
    }
}