            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    System.Net.Mail.MailMessage m = new System.Net.Mail.MailMessage(
                        new System.Net.Mail.MailAddress("sender@servodroid.com", "Web Registration"),
                    ...
                    m.IsBodyHtml = true;
                    System.Net.Mail.SmtpClient smtp = new System.Net.Mail.SmtpClient("smtp.servodroid.com");
                    smtp.Credentials = new System.Net.NetworkCredential("sender@servodroid.com", "password");
                    smtp.EnableSsl = true;
                    smtp.Send(m);
